// lib/features/simulasi/simulation_page.dart

import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
// Import file-file baru
import 'package:project_volt/core/constants/app_color.dart'; // Tetap di sini
...
class _SimulationPageState extends State<SimulationPage> {
  ...
  Offset getNodePosition(String componentId, String nodeId) {
    // Fungsi ini tetap ada di sini karena menggunakan _componentsOnCanvas dan Offset
    try {
  ...
  void _runSimulation() async {
    ...
    final SimulationProject updatedProject = await compute(
      runSimulationInBackground, // Nama fungsi di simulation_logic.dart
      payload,
    );
  ...
  // --- WIDGET WRAPPER GESER/HAPUS (BARU) ---
