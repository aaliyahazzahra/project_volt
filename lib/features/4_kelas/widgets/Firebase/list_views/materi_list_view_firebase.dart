...
class MateriListViewFirebase extends StatelessWidget {
  final List<MateriFirebaseModel> daftarMateri;
  final Function(MateriFirebaseModel) onMateriTap;
  final Color roleColor;

  const MateriListViewFirebase({
    super.key,
